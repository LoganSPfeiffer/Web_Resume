  ...
  return (
    <header className="relative min-h-screen flex items-center justify-center hero-gradient overflow-hidden">
      ...
      <div className="absolute inset-0 flex items-center justify-center pointer-events-none select-none" aria-hidden="true">
        ...
        >
          {/* Left horn */}
          <path d="M60 56 C48 33 22 28 18 44 C32 46 52 58 60 74Z" />
          {/* Right horn */}
          <path d="M140 56 C152 33 178 28 182 44 C168 46 148 58 140 74Z" />
          {/* Head */}
          <path d="M100 34 C68 34 44 58 44 88 C44 120 64 150 100 155 C136 150 156 120 156 88 C156 58 132 34 100 34Z" />
          {/* Left ear */}
          <path d="M46 92 C33 84 29 102 40 107 C46 100 48 93 46 92Z" />
          {/* Right ear */}
          <path d="M154 92 C167 84 171 102 160 107 C154 100 152 93 154 92Z" />
          {/* Snout */}
          <ellipse cx="100" cy="132" rx="26" ry="18" />
        </svg>
      </div>
